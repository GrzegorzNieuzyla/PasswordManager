...
class MenuBar(QMenuBar):
    def __init__(self):
        ...
        self.quit_action.triggered.connect(lambda: QApplication.quit())
    ...
    def set_on_open_db(self, callback: Callable[[], None]):
        self.open_db_action.triggered.connect(callback)  # type: ignore

    def set_on_change_password(self, callback: Callable[[], None]):
        self.change_password_action.triggered.connect(callback)  # type: ignore

    def set_on_preferences(self, callback: Callable[[], None]):
